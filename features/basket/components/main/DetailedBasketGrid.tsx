...
<<<<<<<< HEAD:app/(nav)/(white_nav_layout)/my-basket/components/DetailedBasketGrid.tsx
} from "@/app/(nav)/(white_nav_layout)/my-basket/components/helper-components-calendar";
import SpCounter from "./counter";
========
} from "../../utils/helper-components-calendar";
import SpCounter from "../counter";
>>>>>>>> origin:features/basket/components/main/DetailedBasketGrid.tsx
